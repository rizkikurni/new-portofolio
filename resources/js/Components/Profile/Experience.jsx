                ...
                {experiences.map((experience, index) => (
                    ...
                    >
                        ...
                        <div className="grid gap-5 md:grid-cols-[0.33fr_1fr] md:gap-10">
                            <div>
                                <p className="font-mono text-xs text-gray-500 md:text-sm">{experience.start_date} — {experience.end_date}</p>
                                {experience.is_current && (
                                    <span className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-accent-500/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-accent-400 md:text-xs">
                            ...
                            <div>
                                <div className="flex items-start justify-between gap-5">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm font-semibold text-gray-400 md:text-base">{experience.company}</p>
                                    </div>
                                ...
                                {experience.description && (
                                    <p className="mt-5 max-w-3xl whitespace-pre-line text-sm leading-7 text-gray-400 md:text-base md:leading-8">{experience.description}</p>
                                )}
                            </div>
                        </div>
                    </ScrollReveal>
